...
.reduite.center[![](img/IMG_2788.jpeg)]
...
- Plein de ressources en ligne : [**open Datactivist**](https://open.datactivist.coop/). 
...
> * Maîtriser les enjeux liés à la qualité des données publiques pour faciliter la réutilisation

> * Disposer des informations essentielles pour contribuer à une démarche d'open data dans son institution
...
.reduite[.center[
[![](./img/guide.png)](https://www.cnil.fr/sites/cnil/files/atoms/files/guide-open-data.pdf)
]]
...
Le droit d'accès s'applique aux documents administratifs produits dans le cadre d'une .red[mission de service public] :
...
.pull-left[
[![](./img/carto_obs.png)](https://odf-carto.netlify.app/?datami_tab=2&datami_view=map)

Carte de [l'observatoire open data des territoires](https://www.observatoire-opendata.fr/)
]

.pull-right[
Le [Baromètre de l’Observatoire Datapublica](Le Baromètre de l’Observatoire Datapublica) 
]
...
---
### Exemple de données ouvertes : [Les AD des Hauts-de-Seine](https://opendata.hauts-de-seine.fr/explore/dataset/fr-229200506-cartes-postales/information/)

Un projet mélant open data et indexation collaborative, et un exemple de [réutilisation](https://hauts-de-seine.maps.arcgis.com/apps/MapTour/index.html?appid=b6f18ba4e60647cbbc61d41c041851ff)
...
### Les étapes de la publication de données

---
### Etape 1

.red[Choisir les données à ouvrir]

Identifier les données, définir sa stratégie et analyser l'existant
...
* Les **référentiels ou nomenclatures** : vocabulaires contrôlés, ontologie... 
...
.red[Préparer les données]

- Structurer

- Qualité

- Préparer la description (métadonnées)

---

### Etape 3

.red[Publier les données]
...
### L'exemple des AM de Lyon

.pull-left[

- Partenariat avec Wikimedia depuis 2021 : organisation de formations pour les agents, ateliers pour le public... [Exemple des actions 2024-2025](https://www.archives-lyon.fr/pages/editathons-2024-2025.

- Des images versées dans Wikimedia Commons et des [données en open data](https://data.grandlyon.com/portail/fr/jeux-de-donnees/historique-des-voies-de-la-ville-de-lyon/info)

- Et un label Culture Libre obtenu en 2023
]
